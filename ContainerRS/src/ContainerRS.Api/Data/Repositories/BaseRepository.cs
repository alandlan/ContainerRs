...
namespace ContainerRS.Api.Data.Repositories
{
        ...
        IRepository<T> where T : class
    {
        ...
        public virtual async Task<T?> GetFirstAsync<TProperty>(Expression<Func<T, bool>> predicate, Expression<Func<T, TProperty>> orderBy, CancellationToken cancellationToken = default)
        {
